...
<div class="page-header d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="page-title">New Testimony</h1>
        <p class="page-subtitle">Configure parameters and satisfied user metadata for a new log entry.</p>
    </div>
    ...
    <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-4">
            <div class="col-md-8">
                <div class="mb-4">
                    ...
                    <input type="text" class="v2-form-control" id="client_name" name="client_name" value="{{ old('client_name') }}" placeholder="Full legal or alias identity" required>
                </div>

                <div class="mb-4">
                    <label for="client_position" class="v2-form-label">DESIGNATION / COMPANY</label>
                    <input type="text" class="v2-form-control" id="client_position" name="client_position" value="{{ old('client_position') }}" placeholder="e.g. CEO at TechFlow">
                </div>
                
                <div class="mb-4">
                    <label for="content" class="v2-form-label">ENDORSEMENT DATA (CONTENT)</label>
                    <textarea class="v2-form-control" id="content" name="content" rows="4" placeholder="Input feedback sequence..." required>{{ old('content') }}</textarea>
                </div>
            </div>
            ...
            <div class="col-md-4">
                 ...
                 <div class="mb-4">
                    ...
                    <input type="number" class="v2-form-control" id="rating" name="rating" min="1" max="5" value="{{ old('rating', 5) }}">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="mb-0">
                        ...
                        <input type="url" class="v2-form-control" id="client_image_url" name="client_image_url" value="{{ old('client_image_url') }}" placeholder="https://external-host.io/avatar.png">
                    </div>
        ...
        <div class="d-flex justify-content-end mt-5">
            <button type="submit" class="btn-tech-primary px-5 py-3">
                <i class="fas fa-plus-circle me-2"></i> DEPLOY TESTIMONY
            </button>
        </div>
    </form>
</div>
