        ...
        <div class="row g-4">
            <div class="col-md-8">
                <div class="mb-4">
                    ...
                    <input type="text" class="v3-form-control" id="name" name="name" value="{{ old('name') }}" placeholder="Full legal or alias identity" required>
                </div>

                <div class="mb-4">
                    <label for="position" class="v3-form-label">FUNCTIONAL ROLE</label>
                    <input type="text" class="v3-form-control" id="position" name="position" value="{{ old('position') }}" placeholder="e.g. Lead Cyber Architect" required>
                </div>
                
                <div class="mb-4">
                    <label for="bio" class="v3-form-label">BIOGRAPHICAL DATA</label>
                    <textarea class="v3-form-control" id="bio" name="bio" rows="4" placeholder="Technical background and expertise keywords...">{{ old('bio') }}</textarea>
                </div>

                <div class="row g-4">
                    <div class="col-md-4">
                        <label for="facebook_url" class="v3-form-label">FACEBOOK LINK</label>
                        <input type="url" class="v3-form-control" id="facebook_url" name="facebook_url" value="{{ old('facebook_url') }}" placeholder="https://...">
                    </div>
                    <div class="col-md-4">
                        <label for="twitter_url" class="v3-form-label">TWITTER LINK</label>
                        <input type="url" class="v3-form-control" id="twitter_url" name="twitter_url" value="{{ old('twitter_url') }}" placeholder="https://...">
                    </div>
                    <div class="col-md-4">
                        <label for="linkedin_url" class="v3-form-label">LINKEDIN LINK</label>
                        <input type="url" class="v3-form-control" id="linkedin_url" name="linkedin_url" value="{{ old('linkedin_url') }}" placeholder="https://...">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                ...
                <div class="mb-4">
                    ...
                    <div class="mb-0">
                        ...
                        <input type="url" class="v3-form-control" id="image_url" name="image_url" value="{{ old('image_url') }}" placeholder="https://external-host.io/avatar.png">
                    </div>
