...
<div class="page-header d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="page-title text-white">Recalibrate Workflow Step</h1>
        <p class="page-subtitle text-v2-muted">Modify parameters for step: <span class="text-v2-primary">{{ $workFlow->title }}</span></p>
    </div>
...
<div class="tech-card-v2 p-4">
    ...
    <form action="{{ route('admin.work-flows.update', $workFlow->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row g-4">
            <div class="col-md-8">
                <div class="mb-4">
                    ...
                    <input type="text" name="title" class="v2-admin-input w-100" required value="{{ $workFlow->title }}">

                </div>
                <div class="mb-4">
                    <label class="v2-form-label">DESCRIPTION</label>
                    <textarea name="description" class="v2-admin-input w-100" rows="4" required>{{ $workFlow->description }}</textarea>
            ...
            <div class="col-md-4">
                <div class="mb-4">
                    ...
                    <input type="number" name="display_order" class="v2-admin-input w-100" required value="{{ $workFlow->display_order }}">
                ...
                <div class="mb-0">
                    ...
                    <div class="input-group-v2">
                        ...
                        <input type="text" name="icon_class" id="iconInput" class="v2-admin-input flex-1" required value="{{ $workFlow->icon_class }}">
