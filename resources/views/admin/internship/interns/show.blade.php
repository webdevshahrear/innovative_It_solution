...
<div class="cyber-header d-flex justify-content-between align-items-center" data-aos="fade-down">
    <div>
        ...
        <p class="text-v2-muted mt-2 mb-0" style="font-size: 1rem;">{{ $account->application->full_name }} — Performance, milestones & mentorship logs.</p>
    </div>
...
<div class="row g-4">
        ...
        <div class="tech-card-v2 mb-4 text-center overflow-hidden" style="background: rgba(255,255,255,0.02)">
            ...
            <div class="position-relative z-index-1 mt-3">
                ...
                <div class="d-flex justify-content-center gap-3 mb-4">
                    <div class="px-3 py-2 rounded-3 bg-white bg-opacity-5 border border-secondary" style="min-width: 100px;">
                        <div class="text-v2-muted small text-uppercase fw-bold" style="font-size:0.6rem">Performance</div>
                        <div class="text-white fw-bold">{{ $account->performance_score }}%</div>
                    </div>
                    <div class="px-3 py-2 rounded-3 bg-white bg-opacity-5 border border-secondary" style="min-width: 100px;">
                        <div class="text-v2-muted small text-uppercase fw-bold" style="font-size:0.6rem">Account</div>
            ...
            <div class="text-start p-4 rounded-4 bg-white bg-opacity-5 border border-white border-opacity-5 small mb-4">
                <div class="mb-3 d-flex align-items-center gap-3">
                    <div class="metric-icon-v2" style="width:32px; height:32px; font-size:0.9rem"><i class="fas fa-envelope"></i></div>
                    <div>
                        <div class="text-v2-muted fw-bold" style="font-size:0.65rem">PRIMARY EMAIL</div>
                ...
                <div class="mb-3 d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="text-v2-muted fw-bold" style="font-size:0.65rem">CONTACT LINE</div>
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="text-v2-muted fw-bold" style="font-size:0.65rem">PROGRAM WINDOW</div>
    ...
    <div class="col-lg-8" data-aos="fade-left">
        ...
        <div class="tech-card-v2 position-relative overflow-hidden mb-4 p-0">
            ...
            <div class="table-responsive">
                <table class="table table-v2 mb-0">
                    <thead>
                        <tr>
                            <th style="padding-left:1.5rem">MILESTONE / OBJECTIVE</th>
                            <th>RELEASE DATE</th>
                            <th>PHASE STATUS</th>
                            <th class="text-end" style="padding-right:1.5rem">QUALITY SCORE</th>
                        </tr>
                    </thead>
                    <tbody>
        ...
        {{-- Certification --}}
        <div class="tech-card-v2" style="border: 1px solid rgba(16,185,129,0.2); background: radial-gradient(circle at 100% 0%, rgba(16,185,129,0.05) 0%, transparent 50%)">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                @else
                    <span class="badge border border-danger text-danger bg-danger bg-opacity-10 px-3 py-2" style="font-size:0.7rem">INSUFFICIENT CREDITS</span>
                @endif
            </div>

            @if($account->certificate)
                <div class="p-4 rounded-4 d-flex align-items-center gap-4" style="background: rgba(16,185,129,0.03); border: 1px solid rgba(16,185,129,0.1)">
                    <div class="metric-icon-v2" style="width:60px; height:60px; font-size:2rem; background:rgba(16,185,129,0.1); color:#10b981; border-color:rgba(16,185,129,0.2)">
                        <i class="fas fa-award"></i>
                    </div>
                    <div>
                        <div class="text-white fw-bold fs-5">Professional Internship Certificate Issued</div>
                        <div class="text-v2-muted small">Verification Ledger ID: <span class="text-success fw-mono">{{ $account->certificate->certificate_number }}</span></div>
                        <div class="mt-2">
                             <a href="#" class="btn-v2-primary py-1 px-3" style="font-size:0.8rem; border-radius:6px">
            ...
            @else
                <div class="p-4 rounded-4 d-flex align-items-center justify-content-between" style="background: rgba(255,255,255,0.02); border: 1px solid var(--v2-border)">
                    <div class="d-flex align-items-center gap-3">
                        <div class="metric-icon-v2 opacity-50" style="width:48px; height:48px; font-size:1.4rem">
                            <i class="fas fa-medal"></i>
                        </div>
                        <div>
                            <div class="text-white fw-bold">Credential Generation Locked</div>
                            <div class="text-v2-muted small">Status: Incomplete Program Requirements</div>
                        </div>
                    </div>
                    <button class="btn-premium disabled" style="opacity:0.3; padding: 10px 20px; font-size:0.85rem">
                        <i class="fas fa-lock me-2"></i>Issue Verified Certificate
                    </button>
                </div>
                <div class="mt-3 px-2 d-flex align-items-center gap-2 text-v2-muted small">
                    <i class="fas fa-info-circle text-primary"></i>
                    <span>Intern must achieve a cumulative performance score of 60% or higher across all assigned milestones to unlock certification.</span>
                </div>
            @endif
        </div>
    </div>
