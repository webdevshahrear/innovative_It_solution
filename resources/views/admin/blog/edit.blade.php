        ...
        <div class="row g-4">
            <div class="col-md-9">
                <div class="mb-4">
                    ...
                    <input type="text" class="v2-form-control" id="title" name="title" value="{{ old('title', $blog->title) }}" placeholder="Enter transmission subject..." required>
                </div>

                <div class="mb-4">
                    <label for="content" class="v2-form-label">CONTENT DATA</label>
                    <textarea class="v2-form-control" id="content" name="content" rows="15" placeholder="Initialize content sequence...">{{ old('content', $blog->content) }}</textarea>
                </div>
            </div>
...
<style>
    ...
    .asset-preview-v2 img { width: 100%; height: 150px; object-fit: cover; }
